...
/**
 * v2 · Dithered Intelligence with the "Desk" hero plate.
 *
...
const concept = getConcept('v2')!;

export const metadata: Metadata = {
  title: 'V2 · Desk plate',
  description:
    'MappedLabs — Dithered Intelligence with the Desk hero plate. Overhead: hands among printed charts and annotated pages.',
};
